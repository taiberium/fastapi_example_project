...
class CRUDRepository(Generic[ORMModel]):
    ...
    def _commit(self) -> None:
        # Commit each write here (CRUD level). Roll back on a failed commit so the
        # session stays usable, and surface unique violations as a domain error
        # instead of leaking IntegrityError upward.
        try:
